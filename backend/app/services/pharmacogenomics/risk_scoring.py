...
class RiskScoreCalculator:
    ...
    def calculate_risk_score(
        ...
        # Low confidence → reduce score significantly to reflect uncertainty
        # confidence=1.0 → factor=1.00 (no penalty)
        # confidence=0.5 → factor=0.75 (25% reduction)
        # confidence=0.0 → factor=0.50 (50% reduction) - prev was 0.70
