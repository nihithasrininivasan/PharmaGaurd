...
class DiplotypeResult(BaseModel):
    ...
    confidence_breakdown: Optional[Dict] = Field(None, description="Itemised confidence component scores")
    activity_score: Optional[float] = Field(None, description="Total activity score for the diplotype")
    allele_scores: Optional[Dict[str, float]] = Field(None, description="Individual activity scores for each allele")
...
class PharmacogenomicProfile(BaseModel):
    ...
    activity_score: Optional[float] = Field(None, description="Total activity score")
    allele_scores: Optional[Dict[str, float]] = Field(None, description="Individual allele scores")
    notes: Optional[str] = Field(None, description="Process notes/disclaimers")
