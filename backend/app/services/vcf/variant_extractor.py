...
def extract_pharmacogenes(
    ...
    *,
    ...
    for v in variants:
        ...
        # Prepare raw_info with injected QUAL/FILTER
        info_dict = dict(v.info) if isinstance(v.info, dict) else {"INFO": v.info}
        info_dict["QUAL"] = v.qual
        info_dict["FILTER"] = v.filter
